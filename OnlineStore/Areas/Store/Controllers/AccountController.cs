...
using OnlineStore.Areas.Store.Models.AccountViewModels;
...
using OnlineStore.Areas.Store.Controllers;
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        return RedirectToAction("Index", "Home", new { area = "StoreManagement"/*, id = userId */});
                    }
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                user.Gender = (model.IsMan == true ? model.IsMan : model.IsWoman);
                user.PhoneNumber = null;
                user.Birthday = model.Birthday;
                user.CreateByUserId = user.Id;
